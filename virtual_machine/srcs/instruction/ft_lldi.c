...
/*   Updated: 2020/03/26 17:36:52 by danglass         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_lldi(t_process *process, t_vm *vm)
{
	...
	param_1 = ft_lldi_param_recover_value(vm, process, vm->param[0]);
	param_2 = ft_lldi_param_recover_value(vm, process, vm->param[1]);
	param_3 = ft_lldi_param_recover_value(vm, process, vm->param[2]);
